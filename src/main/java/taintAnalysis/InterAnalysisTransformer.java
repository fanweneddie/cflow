...
/**
 * A transformer for the whole process of backend(for inter-procedural analysis),
 * which includes doing dataflow analysis and path reconstruction.
 */
public class InterAnalysisTransformer extends SceneTransformer {
    ...
    public InterAnalysisTransformer(ISourceSinkManager sourceSinkManager,
                                    ITaintWrapper taintWrapper, boolean do_points_to) {
        this.analysis = new InterTaintAnalysis(sourceSinkManager, taintWrapper, do_points_to);
    }
