...
public interface ITaintWrapper {
     ...
     * @param uniqueStmt    The invocation statement which to check for black-box taint propagation
     ...
     */
    void genTaintsForMethodInternal(Set<Taint> in, UniqueStmt uniqueStmt, SootMethod caller,
